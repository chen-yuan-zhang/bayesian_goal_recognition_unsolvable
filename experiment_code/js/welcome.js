...
welcome.task = {};
welcome.task.blurb = '<b>"Sokoban"</b> is a short psychological study investigating how people solve problems.';
welcome.task.time = '40 minutes';
welcome.task.pay = '£8';
...
welcome.ethics.description = 'If you decide to participate, we will present you with some problems in which you need to control the worker to push the box to the target. The task should take approximately ' + welcome.task.time + ' to complete including reading time.';
...
welcome.section.start =
    ...
    '<p>Thanks for joining this experiment. ' + welcome.task.blurb + ' It involves the following steps:</p>' +
    '<ol>' +
